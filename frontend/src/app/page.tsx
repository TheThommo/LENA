...
const PRICING = [
  ...
  },
  {
    ...
    features: [
      'Unlimited searches',
      'All 15 sources',
      'PDF export & content ingest (URL/PDF/image)',
      'Up to 5 projects · single user',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Unlimited projects & team sharing',
      'Custom My Brain · priority queue',
      'Saved-search alerts · bulk PDF export',
    ],
    cta: 'Upgrade to Pro',
    href: '/register',
  ...
  },
  {
    ...
    features: [
      'Everything in Pro',
      'Multi-seat · white-label / co-brand',
      'Tenant analytics · custom sources · SSO',
      'SLA & volume pricing — contact us',
    ],
    cta: 'Contact us',
