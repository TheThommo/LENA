      ...
      <div className="space-y-4">
        ...
        {filteredResults.length > 0 && (
          <>
            ...
            {/* Bottom action bar — repeat key actions after results so users don't scroll back up */}
            {response && !response.guardrail_triggered && filteredResults.length > 0 && (
      ...
      {projectPickerOpen && pickerPos && onAddToProject && (
        ...
        >
          ...
          {onCreateProject && !creatingProject && (
            <button
              onClick={() => { setCreatingProject(true); setCreateUpgradeCta(null); }}
          ...
          {onCreateProject && creatingProject && (
            ...
            >
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <button
                  type="button"
                  onClick={() => { setCreatingProject(false); setNewProjectName(''); setCreateUpgradeCta(null); }}
