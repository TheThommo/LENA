          ...
          <div className="flex flex-wrap gap-1.5">
            {trending.map(({ topic, count, trend, is_fallback }) => (
              ...
              >
                ...
                {!is_fallback && count > 0 && (
                  <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-medium text-slate-500 bg-slate-100 rounded-full group-hover:bg-lena-100 group-hover:text-lena-700">
                    {count}
                    {trend === 'up' && (
